...
- Per-device profiles: phones and tablets pick up the Touch screen profile, computers the Desktop one (hands-free on the phone, push-to-talk on the desktop); name devices and assign any profile to any of them.
